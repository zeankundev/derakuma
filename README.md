...
If you want a more in-depth coverage on how to implement, refer to the [Getting Started](https://github.com/zeankundev/derakuma/wiki/Getting-started) page on the wiki.
